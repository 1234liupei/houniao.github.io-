    ...
    afterLoad: function (anchorLink, index) {
                ...
                $(".section2 .p2")
                  ...
                  .animate({ opacity: 0 }, function () {
                    $(".section2 .p3").animate({ opacity: 1 }, function () {
                      $(".section2 .p3").delay(2000).animate({ opacity: 0 });
                    });
                  });
              });
            });
      ...
      if (index == 14) {
        $(".section14 .p1")
          .stop()
          .animate({ opacity: 1 }, function () {
            $(".section14 .p1").delay(2000).stop().animate({ opacity: 0 });
          });
      }
      if (index == 15) {
        $(".section15 .p1")
          .stop()
          .animate({ opacity: 1 }, function () {
            $(".section15 .p1").delay(2000).stop().animate({ opacity: 0 });
          });
      }
      if (index == 16) {
        $(".section16 .p1")
          .stop()
          .animate({ opacity: 1 }, function () {
            $(".section16 .p1").delay(2000).stop().animate({ opacity: 0 });
          });
      }
    },
  });
